export const enTranslations = {
  ...
  home: {
    ...
    subtitle: "I am software engineering student, with a strong interest in web development and AI. I am also interested in DevOps and cloud computing.",
    aboutButton: "About Me",
    projectsButton: "View Projects",
    technologies: {
      title: "Technologies I Work With",
      description: "I'm proficient in a wide range of technologies across DevOps, cloud, web development, mobile, and AI.",
    },
  },
  about: {
    title: "About Me",
  ...
  projects: {
    ...
    projectsList: {
      hive: {
        title: "Hive – Microservices Architecture",
        description:
          "Implemented a microservices architecture for project management using Spring Boot, Docker, Angular, Java, Spring Cloud, and Spring Security.",
        category: "web",
      },
      myEcolo: {
        title: "MyEcolo – Food Waste Management",
        description:
          "Designed and developed an application for managing food waste using PHP, Laravel, MySQL, Git, and GitHub.",
        category: "web",
      },
      genCare: {
        title: "GenCare – Mental Health Support",
        description:
          "Developed a mental health support web application in Darija using Python, web scraping (Selenium), and Flask.",
        category: "ai",
      },
      asteroidWatch: {
        title: "AsteroidWatch – Asteroid Monitoring",
        description:
          "Real-time monitoring and detection of asteroids with early warning, coordination, risk analysis, prediction, and trajectory tracking.",
        category: "ai",
      },
      usedCars: {
        title: "Used Cars Price Prediction",
        description:
          "Developed a predictive model to estimate used car prices based on various features using linear regression and the Lasso algorithm.",
        category: "ai",
      },
      ecs: {
        title: "ECS – ENSIAS Internship Management",
        description:
